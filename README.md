...
**Android-редirect:** только телефоны (`Android` + `Mobile`). iOS, desktop и планшеты остаются на cooknews.space. После смены env — **Redeploy**. Сборка не трогает статьи (RSS/AI не запускаются).
